package com.nini.bookstore.catalog.web;
...
import com.nini.bookstore.catalog.AbstractIT;
import com.nini.bookstore.catalog.domain.Product;
...
class ProductControllerTest extends AbstractIT {
    ...
    void shouldReturnNotFoundWhenProductCodeNotExists() {
        ...
        given().contentType(ContentType.JSON)
                ...
                .body("detail", is("Product with code " + code + " was not found"));
    }
}
